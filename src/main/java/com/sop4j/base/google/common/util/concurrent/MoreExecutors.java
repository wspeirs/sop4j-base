...
import com.sop4j.base.google.common.collect.Queues;
import com.sop4j.base.google.common.util.concurrent.ForwardingListenableFuture.SimpleForwardingListenableFuture;
...
public final class MoreExecutors {
  ...
  public static ThreadFactory platformThreadFactory() {
    ...
    try {
      return (ThreadFactory) Class.forName("com.sop4j.base.google.appengine.api.ThreadManager")
  ...
  private static boolean isAppEngine() {
    if (System.getProperty("com.sop4j.base.google.appengine.runtime.environment") == null) {
      return false;
    }
    try {
      // If the current environment is null, we're not inside AppEngine.
      return Class.forName("com.sop4j.base.google.apphosting.api.ApiProxy")
