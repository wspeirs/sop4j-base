...
public interface ListenableFuture<V> extends Future<V> {
   ...
   * com.sop4j.base.google.common.util.concurrent.Futures}. For a simplified but general
   * listener interface, see {@link
   * com.sop4j.base.google.common.util.concurrent.Futures#addCallback addCallback()}.
   *
