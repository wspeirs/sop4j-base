...
import com.sop4j.base.joda.time.chrono.BaseChronology;
import com.sop4j.base.joda.time.field.FieldUtils;
import com.sop4j.base.joda.time.format.DateTimeFormatter;
import com.sop4j.base.joda.time.format.DateTimeFormatterBuilder;
import com.sop4j.base.joda.time.format.FormatUtils;
import com.sop4j.base.joda.time.tz.DefaultNameProvider;
import com.sop4j.base.joda.time.tz.FixedDateTimeZone;
import com.sop4j.base.joda.time.tz.NameProvider;
import com.sop4j.base.joda.time.tz.Provider;
import com.sop4j.base.joda.time.tz.UTCProvider;
import com.sop4j.base.joda.time.tz.ZoneInfoProvider;
...
public abstract class DateTimeZone implements Serializable {
     ...
     * <p>
     * Tries the system property <code>com.sop4j.base.joda.time.DateTimeZone.Provider</code>.
     * Then tries a <code>ZoneInfoProvider</code> using the data in <code>com.sop4j.base.joda/time/tz/data</code>.
    ...
    private static Provider getDefaultProvider() {
        ...
        try {
            String providerClass =
                System.getProperty("com.sop4j.base.joda.time.DateTimeZone.Provider");
        ...
        if (provider == null) {
            try {
                provider = new ZoneInfoProvider("com.sop4j.base.joda/time/tz/data");
            } catch (Exception ex) {
                Thread thread = Thread.currentThread();
                thread.getThreadGroup().uncaughtException(thread, ex);
            }
     ...
     * <p>
     * Tries the system property <code>com.sop4j.base.joda.time.DateTimeZone.NameProvider</code>.
    ...
    private static NameProvider getDefaultNameProvider() {
        ...
        try {
            String providerClass = System.getProperty("com.sop4j.base.joda.time.DateTimeZone.NameProvider");
            if (providerClass != null) {
                try {
